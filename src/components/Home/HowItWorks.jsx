...
import { FaUserPlus, FaSearch, FaFileAlt, FaCheckCircle, FaMoneyBillWave } from "react-icons/fa";

const steps = [
  {
    id: 1,
    title: "Register Account",
    description: "Sign up as a borrower or manager using email and password.",
  ...
  },
  {
    id: 2,
    title: "Explore Loans",
    description: "Browse available microloans with interest, EMI, and max limit info.",
  ...
  },
  {
    ...
    description: "Fill in personal & financial info to submit a loan application.",
  ...
  },
  {
    id: 5,
    title: "Receive Loan",
    description: "Loan is disbursed and EMI schedules are tracked automatically.",
  ...
  return (
    <section className="bg-gray-50 py-24">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div ref={ref} className="relative flex flex-col md:flex-row items-center md:justify-between">
          {steps.map((step, index) => (
            <motion.div
              ...
              animate={controls}
              variants={{
                visible: { opacity: 1, y: 0, transition: { duration: 0.6, delay: index * 0.3 } },
              }}
            >
              {/* Animated Connector */}
