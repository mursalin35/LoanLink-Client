...
const TrustBar = () => {
  ...
  return (
    <section className="py-20 bg-[#F3FBF9] dark:bg-[#11121A]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-[#1C1C28] dark:text-[#E6F4F1]">
            Trusted by Thousands
          </h2>
          <p className="mt-4 text-[#5F6C72] dark:text-gray-300 mx-auto text-base">
            ...
            return (
              ...
              >
                ...
                <div className="w-14 h-14 rounded-xl bg-[#E8FAF7] dark:bg-[#232634] flex items-center justify-center transition-colors duration-300 group-hover:bg-[#1F7A63]">
                  <Icon className="w-7 h-7 text-[#1F7A63] dark:text-[#B6E04C] transition-colors duration-300 group-hover:text-white" />
                </div>

                {/* Content */}
                <h3 className="mt-6 text-lg font-semibold text-[#1C1C28] dark:text-[#E6F4F1]">
                  {item.title}
                </h3>

                <p className="mt-3 text-sm text-[#5F6C72] dark:text-gray-400 leading-relaxed">
                  {item.desc}
                </p>

                {/* Accent Line */}
                <div className="mt-5 h-[3px] w-10 rounded-full bg-[#4FD1B2] dark:bg-[#6FBF73] opacity-70 group-hover:w-16 transition-all duration-300"></div>
              </motion.div>
            );
          })}
        </div>
