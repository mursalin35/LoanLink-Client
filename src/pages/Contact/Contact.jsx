...
const Contact = () => {
  ...
  return (
  <div className="min-h-screen bg-gray-50 text-gray-700 dark:bg-[#0f1f1c] dark:text-gray-300 font-sans">
  <title>Contact</title>

  {/* Hero Section */}
  <section className="bg-gradient-to-r from-[#004d40] to-[#00695c] dark:from-[#0b2e28] dark:to-[#0f3d36] text-white h-64 px-6 text-center">
    <motion.h1
    ...
    <motion.p
      ...
      className="mt-4 text-lg md:text-xl max-w-2xl mx-auto text-gray-100 dark:text-gray-300"
    >
  ...
  <section className="max-w-6xl mx-auto px-6 md:px-0 -mt-20 grid grid-cols-1 md:grid-cols-2 gap-12">
    ...
    >
      {[
        ...
        <div
          key={idx}
          className="p-6 rounded-xl shadow-lg bg-white dark:bg-[#132e2a] border-l-4 border-[#8bc34a]"
        >
          <h3 className="text-xl font-semibold text-[#004d40] dark:text-[#9fe870] mb-2">
            {info.title}
          </h3>
    ...
    <motion.form
      ...
      className="bg-white dark:bg-[#132e2a] p-8 rounded-2xl shadow-2xl space-y-5 border border-gray-200 dark:border-gray-700"
    >
      <h2 className="text-2xl font-bold text-[#004d40] dark:text-[#9fe870] mb-4">
        Send a Message
      </h2>
  ...
  <section className="mt-20 px-6 md:px-0 max-w-6xl mx-auto">
    <motion.h3
      ...
      viewport={{ once: true }}
      className="text-4xl font-bold text-[#004d40] dark:text-[#9fe870] mb-6 text-center"
    >
      Our Location
    </motion.h3>

    <div className="w-full h-80 md:h-96 rounded-2xl overflow-hidden shadow-2xl border border-gray-200 dark:border-gray-700">
      <iframe
