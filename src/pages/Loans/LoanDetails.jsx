    ...
    <div className="flex flex-col lg:flex-row gap-10">
      ...
      <div className="lg:w-1/2 flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div className="p-5 rounded-2xl bg-white/80 dark:bg-[#1C1C28]/80 backdrop-blur-md shadow-lg border border-[#E0E0E0] dark:border-[#333847] hover:scale-105 transform transition-all duration-300">
            <p className="text-[#1C2B27] dark:text-[#E6F4F1] font-semibold mb-2">Category</p>
            <p className="text-[#6FBF73]">{loan.category}</p>
          </div>

          <div className="p-5 rounded-2xl bg-white/80 dark:bg-[#1C1C28]/80 backdrop-blur-md shadow-lg border border-[#E0E0E0] dark:border-[#333847] hover:scale-105 transform transition-all duration-300">
            <p className="text-[#1C2B27] dark:text-[#E6F4F1] font-semibold mb-2">Interest Rate</p>
          ...
          <div className="p-5 rounded-2xl bg-white/80 dark:bg-[#1C1C28]/80 backdrop-blur-md shadow-lg border border-[#E0E0E0] dark:border-[#333847] hover:scale-105 transform transition-all duration-300">
            <p className="text-[#1C2B27] dark:text-[#E6F4F1] font-semibold mb-2">Max Loan</p>
            <p className="bg-gradient-to-r from-[#B6E04C] to-[#6FBF73] inline-block px-3 py-1 rounded-full text-white font-bold">
              ${loan.maxLimit}
            </p>
          </div>
          ...
          <div className="p-5 rounded-2xl bg-white/80 dark:bg-[#1C1C28]/80 backdrop-blur-md shadow-lg border border-[#E0E0E0] dark:border-[#333847] hover:scale-105 transform transition-all duration-300">
            <p className="text-[#1C2B27] dark:text-[#E6F4F1] font-semibold mb-2">Available EMI Plans</p>
            <p className="text-[#6FBF73]">{loan.emiPlans?.join(", ") || "N/A"}</p>
          </div>
        </div>
