...
const DashboardLayout = () => {
  ...
  return (
    <div className="flex min-h-screen bg-[#F4F7F5]">
      ...
      <div
        className={`
          fixed z-50 top-0 left-0 h-full bg-[#1F4F45] text-white shadow-lg flex flex-col transition-transform duration-300
          ${
            isMobile
              ? open
                ? "translate-x-0"
        ...
        <div className="flex flex-col h-full z-50">
          ...
          <div className="p-4 border-t border-[#ffffff33]">
            <button
              ...
              className="flex items-center gap-3 w-full p-2 rounded-lg hover:bg-red-100 hover:text-red-600 text-[#B6E04C] transition-all duration-200"
            >
              <FaSignOutAlt />
              <span>Logout</span>
            </button>
      ...
      <div className="flex-1 flex flex-col md:ml-64">
        {/* Top Navbar */}
        <div className="flex justify-between items-center h-16 px-6 shadow-md bg-[#e5f4e3] border-b border-[#E0E7E2] sticky top-0 z-30">
          <div className="flex items-center gap-4">
            {isMobile && (
              <button
                className="text-[#1F4F45] hover:text-[#6FBF73] transition-colors"
          ...
          <Link to="/">
            <div className="flex items-center gap-3">
              ...
              />
              <p className="font-medium text-[#1C2B27]">
